<template>
  <div class="container d-flex flex-column mt-5">
    ...
    />
    <!-- Premier Bloc contenant les informations personnelles et la deconnexion du compte -->

    <div class="card mt-5 p-5 card__perso">
      <h1 class="card__title container d-flex justify-content-center p-5">
        Bienvenue {{ user.username }}
      </h1>

      <p class="container d-flex justify-content-center">Votre bio:</p>
      <p class="container card d-flex justify-content-center p-5 bio__content">
        {{ user.bio }}
      </p>
      ...
      <div class="flex-wrap justify-content-center p-5">
        ...
        <button
          @click="logout()"
          class="button btn btn__x justify-content-center p-2 mt-3"
        >
          Déconnexion
        </button>
      </div>
    ...
    <!-- Deuxième bloque pour les fonctionnalités Changer de mot de passe(pas encore mis en place) / modifier les infos / supprimer son compte -->

    <div class="card p-5 mt-5 p-1 card__modify">
      <p v-if="mode == 'profile'">
        <i @click="switchModify()" class="fas p-2 btn fa-user p-1"></i>Modifier
      ...
      <div>
        <p>
          <i @click="deleteUser()" class="fas fa-user-times p-2 btn"></i
...
export default {
  ...
  methods: {
    ...
    // Pour changer l'affichage et permettre la modification du profile ou non
...
/************************************************************************* Appelle fonction Déconnecter un utilisateur *******************************************************************************/
...
/************************************************************************* Appelle fonction Modifier un utilisateur *******************************************************************************/
    ...
    modifyUser: function () {
      ...
      axios
        .put("http://localhost:3000/api/users/myprofile", userModifySend)
        .then((response) => {
...
/************************************************************************* Appelle fonction Supprimer un utilisateur *******************************************************************************/
